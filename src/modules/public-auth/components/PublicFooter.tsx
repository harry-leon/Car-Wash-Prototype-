        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#services" className="hover:text-foreground transition-colors">{t("Services", "Dịch Vụ")}</a></li>
              <li><a href="#combos" className="hover:text-foreground transition-colors">{t("Monthly Packages", "Gói Tháng")}</a></li>
              <li><a href="#reviews" className="hover:text-foreground transition-colors">{t("Customer Reviews", "Đánh Giá Khách Hàng")}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>📍 {t("123 Nguyen Van Linh, District 7, HCMC", "123 Nguyễn Văn Linh, Q.7, TP.HCM")}</li>
              <li>📞 0901 234 567</li>
